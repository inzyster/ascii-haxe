...
class ANSIRenderer
{
									...
									)
	{
		...
		var characterRect : Rectangle = _rectangleForCharacterAtIndex( characterIndex );
		
		targetBitmapData.copyPixels( _colorPalette, _rectangleForCharacterAtIndex( backgroundColorIndex ), targetPoint );
		targetBitmapData.copyPixels( _characterTextures[ textColorIndex ], characterRect, targetPoint, null, null, true );
	}
